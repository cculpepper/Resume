...
\email{Christopher.R.Culpepper@gmail.com}
\phone{(413) 376-5034}
\address{51 Irene St.}
\address{Chicopee MA 01013}
\website{www.github.com/cculpepper}
\website{www.ab1tj.com}
...
{\sl Electrical Engineer} \hfill {\sl October 2019 - Present}\\
  ...
  %       \item Reverse engineered commercial RADAR to control magnetron
  %           (UART, GPIO, RF Mixer, LNA)
        ...
        \item Designed LED illumination array for blood clot detection
		...
		% \item Designed mechanical hardware for small scale production
	\end{itemize}
	\vspace{-10pt}
...
\section{PROJECTS}
	...
	% 		% \item Worked together with team to build roll cage and car to specifications under deadlines
    ...
    {\sl Home Networking (Homelab)}
		\begin{itemize} \itemsep -2pt
            ...
            \item DIY'ed comms wiring, on and off-site backup, storage
	...
	% {\sl Bluetooth Split Mechanical Keyboard (In Progress)}
		% \begin{itemize} \itemsep -2pt
			...
			% \item Keyboard PCB acts as mechanical plate to secure the keyswitches
	...
	%\\[-5ex]
		\begin{multicols}{2}
			\begin{itemize}
                ...
                \item[] Networking, subnetting, servers
	...
	{Languages \& Software:} %\\%[-5ex]
		\begin{multicols}{2}
			\begin{itemize}
				...
				\item[] Python
                \item[] Linux/UNIX (Arch, Debian, BSDs)
				\item[] VHDL
...
\section{PERSONAL INTERESTS \\ AND HOBBIES}             
	...
	% \item[]Working towards pilot license
