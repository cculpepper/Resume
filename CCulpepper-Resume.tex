...
{\sl Electrical Engineer} \hfill {\sl October 2019 - Present}\\
	...
	\begin{itemize}  \itemsep -2pt % reduce space between items
        ...
        \item Reverse engineered commercial RADAR to implement our own control 
            (Serial, GPIO, RF LNA)
...
\section{PROJECTS}
    ...
    {\sl FPGA SDR RF Exploration (in progress)}
		\begin{itemize} \itemsep -2pt
			\item Building FPGA SDR exploration system to learn RF, VHDL, DSP
            \item Initially using RF "lego" modules, transitioning to custom PCBs
            \item Created custom drivers for frequency generation, ADC, I2S
